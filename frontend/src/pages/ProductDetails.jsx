...
const ProductDetails = () => {
    ...
    return product && (
        <div className="mt-16">
            <p>
                <Link className="cursor-pointer hover:text-primary" to={'/'}>Home</Link> /{ ' '}
                <Link className="cursor-pointer hover:text-primary" to={'/products'}>Products</Link> /
                <Link className="cursor-pointer hover:text-primary" to={`/products/${product.category.toLowerCase()}`}> {product.category}</Link> /
